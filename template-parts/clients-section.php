    ...
    <div id="clients" class="section-padding bg-gray">
      <div class="container">
        <div class="section-header text-center">
          <h2 class="section-title wow fadeInDown" data-wow-delay="0.3s"><?php echo esc_html(get_theme_mod('clients_section_title')); ?></h2>
          <p><?php echo esc_html(get_theme_mod('clients_section_desc')); ?></p>
        </div>
